    ...
    public class Startup {
        ...
        public void ConfigureServices(IServiceCollection services) {
            services.AddDbContext<PridContext>(opt => { 
                ...
                opt.UseMySql(Configuration.GetConnectionString("prid-2021-a06-mysql")); 
            });
            //services.AddDbContext<PridContext>(opt => opt.UseMySql(
                //Configuration.GetConnectionString("prid-2021-a06-mysql"))
            //);
            ...
            //services.AddControllers()
                //.AddNewtonsoftJson();  // see: https://medium.com/@samichkhachkhi/system-text-json-vs-newtonsoft-json-d01935068143
                                       // see: https://stackoverflow.com/a/32163311
